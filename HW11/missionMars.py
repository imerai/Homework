...
# Function to scrape NASA Mars News
def mars_news_function():
    # Call browser initilizer function
    ...
    # Find the heading under the div tag
    ...
    # Find the new heading under the div tag
...
def Feature_Image_function():
    ...
    # Find the image under the div tag
...
# Function to storage Mars hemisphere images
